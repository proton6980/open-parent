package com.open.extend.manager.function.client.service.impl;
...
import com.open.extend.manager.function.client.domain.bo.SysClientBo;
import com.open.extend.manager.function.client.domain.vo.SysClientVo;
import com.open.extend.manager.function.client.mapper.ISysClientMapper;
...
public class SysClientServiceImpl extends ServiceImpl<ISysClientMapper, SysClient> implements ISysClientService {
    ...
    public SysClientVo queryById(Long id) {
        ...
        vo.setGrantTypeList(Arrays.asList(vo.getGrantType().split(",")));
        return vo;
    }
    ...
    public TableDataInfo<SysClientVo> queryPageList(SysClientBo bo, PageQuery pageQuery) {
        ...
        result.getRecords().forEach(r -> r.setGrantTypeList(Arrays.asList(r.getGrantType().split(","))));
