package com.open.extend.manager.function.tenant.domain.bo;
...
public class SysTenantBo extends BaseAdminEntity {
     ...
     * 联系人
     */
    @NotBlank(message = "联系人不能为空", groups = {Save.class, Update.class})
     ...
     * 企业名称
     */
    @NotBlank(message = "企业名称不能为空", groups = {Save.class, Update.class})
     ...
     * 租户套餐编号
     */
    @NotNull(message = "租户套餐不能为空", groups = {Save.class})
