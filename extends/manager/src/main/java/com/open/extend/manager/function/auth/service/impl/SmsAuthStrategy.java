...
import com.open.extend.manager.function.auth.bo.SmsLoginBody;
...
public class SmsAuthStrategy implements IAuthStrategy {
    ...
    private boolean validateSmsCode(String tenantId, String phonenumber, String smsCode) {
        ...
        if (StringUtils.isBlank(code)) {
            tokenService.recordLoginInfo(tenantId, phonenumber, Constants.LOGIN_FAIL, I18nUtils.message("user.jcaptcha.expire"));
