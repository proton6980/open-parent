package com.open.extend.manager.function.post.service.impl;
...
import com.open.extend.manager.function.post.domain.SysPost;
import com.open.extend.manager.function.userpost.domain.SysUserPost;
import com.open.extend.manager.function.post.domain.bo.SysPostBo;
...
import com.open.extend.manager.function.post.service.ISysPostService;
...
@Service
public class SysPostServiceImpl extends ServiceImpl<ISysPostMapper, SysPost> implements ISysPostService {
    ...
    private LambdaQueryWrapper<SysPost> buildQueryWrapper(SysPostBo bo) {
        ...
        wrapper.like(StringUtils.isNotBlank(bo.getPostCode()), SysPost::getPostCode, bo.getPostCode())
            ...
            .eq(Objects.nonNull(bo.getEnable()), SysPost::getEnable, bo.getEnable())
    ...
    public List<Long> selectPostListByUserId(Long userId) {
        ...
        return StreamUtils.toList(list, SysPostVo::getId);
    }
    ...
    public List<SysPostVo> selectPostByIds(List<Long> postIds) {
        return baseMapper.selectVoList(new LambdaQueryWrapper<SysPost>()
            ...
            .eq(SysPost::getEnable, Constants.NORMAL)
