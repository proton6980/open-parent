package com.open.extend.manager.function.config.service.impl;
...
import com.open.common.business.service.IConfigService;
...
import com.open.extend.manager.function.config.domain.bo.SysConfigBo;
import com.open.extend.manager.function.config.domain.vo.SysConfigVo;
...
@Service
public class SysConfigServiceImpl extends ServiceImpl<ISysConfigMapper, SysConfig> implements ISysConfigService, IConfigService {
    ...
    private LambdaQueryWrapper<SysConfig> buildQueryWrapper(SysConfigBo bo) {
        ...
        lqw.eq(Objects.nonNull(bo.getIsInner()), SysConfig::getIsInner, bo.getIsInner());
    ...
    public void deleteConfigByIds(Long[] configIds) {
        for (Long configId : configIds) {
            ...
            if (Boolean.TRUE.equals(config.getIsInner())) {
    ...
    public String getConfigValue(String configKey) {
        return SpringUtil.getBean(this.getClass()).selectConfigByKey(configKey);
    }
