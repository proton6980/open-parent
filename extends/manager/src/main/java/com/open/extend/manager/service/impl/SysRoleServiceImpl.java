...
import com.open.extend.manager.domain.bo.SysRoleBo;
...
import com.open.extend.manager.mapper.SysUserRoleMapper;
import com.open.extend.manager.service.ISysRoleService;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    public int updateRole(SysRoleBo bo) {
        ...
        if (Constants.DISABLE.equals(role.getStatus()) && this.countUserRoleByRoleId(role.getId()) > 0) {
    ...
    public int updateRoleStatus(Long roleId, String status) {
        if (Constants.DISABLE.equals(status) && this.countUserRoleByRoleId(roleId) > 0) {
            throw new RuntimeException("角色已分配，不能禁用!");
        }
