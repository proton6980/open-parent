package com.open.extend.manager.function.operatelog.domain.vo;
...
public class SysOperateLogVo implements Serializable {
    ...
    public String getOperIpStr() {
        return Objects.nonNull(operIp) ? RegionUtils.getCityInfo(operIp) : StrUtil.EMPTY;
    }
}
