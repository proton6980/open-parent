...
import com.open.commons.service.IDeptService;
...
@Service
public class SysDeptServiceImpl implements ISysDeptService, IDeptService {
    ...
    public List<SysDeptVo> selectDeptByIds(List<Long> deptIds) {
        return baseMapper.selectDeptList(new LambdaQueryWrapper<SysDept>()
                ...
                .eq(SysDept::getStatus, Constants.NORMAL)
    ...
    public int insertDept(SysDeptBo bo) {
        ...
        if (!Constants.NORMAL.equals(info.getStatus())) {
    ...
    public int updateDept(SysDeptBo bo) {
        ...
        if (Constants.NORMAL.equals(dept.getStatus()) && StringUtils.isNotEmpty(dept.getAncestors())
    ...
    private void updateParentDeptStatusNormal(SysDept dept) {
        ...
        baseMapper.update(null, new LambdaUpdateWrapper<SysDept>()
                .set(SysDept::getStatus, Constants.NORMAL)
