package com.open.extend.manager.function.role.controller;
...
import com.open.extend.manager.function.role.domain.vo.DeptTreeSelectVo;
...
public class SysRoleController extends BaseController {
    ...
    public R<Void> changeStatus(@RequestBody SysRoleBo role) {
        roleService.checkRoleAllowed(role);
        roleService.checkRoleDataScope(role.getId());
        return toAjax(roleService.updateRoleStatus(role.getId(), role.getEnable()));
    }
