package com.open.extend.manager.function.client.controller;
...
public class SysClientController extends BaseController {
    ...
    @RepeatSubmit()
    @PostMapping()
    public R<Void> add(@Validated(Save.class) @RequestBody SysClientBo bo) {
    ...
    @RepeatSubmit()
    @PutMapping()
    public R<Void> edit(@Validated(Update.class) @RequestBody SysClientBo bo) {
    ...
    public R<Void> remove(@NotEmpty(message = "主键不能为空")
        ...
        return toAjax(sysClientService.deleteWithValidByIds(Arrays.asList(ids), true));
    }
}
