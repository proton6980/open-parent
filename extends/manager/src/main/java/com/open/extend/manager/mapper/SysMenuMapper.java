 ...
 * @author open
 */
public interface SysMenuMapper extends IBaseMapper<SysMenu, SysMenuVo> {
    ...
    default List<SysMenu> selectMenuTreeAll() {
        LambdaQueryWrapper<SysMenu> lqw = new LambdaQueryWrapper<SysMenu>()
            .in(SysMenu::getMenuType, com.open.commons.constants.Constants.TYPE_DIR,
                    com.open.commons.constants.Constants.TYPE_MENU)
            .eq(SysMenu::getStatus, com.open.commons.constants.Constants.MENU_NORMAL)
