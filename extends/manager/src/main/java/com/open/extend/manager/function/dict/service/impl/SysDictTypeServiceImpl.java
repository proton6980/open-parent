...
import com.open.extend.manager.function.dict.domain.bo.SysDictTypeBo;
import com.open.extend.manager.function.dict.domain.vo.SysDictDataVo;
import com.open.extend.manager.function.dict.domain.vo.SysDictTypeVo;
...
import com.open.extend.manager.function.dict.service.ISysDictTypeService;
...
public class SysDictTypeServiceImpl extends ServiceImpl<ISysDictTypeMapper, SysDictType> implements ISysDictTypeService, IDictService {
    ...
    public boolean checkDictTypeUnique(SysDictTypeBo dictType) {
        boolean exist = baseMapper.exists(new LambdaQueryWrapper<SysDictType>()
                ...
                .ne(ObjectUtil.isNotNull(dictType.getDictId()), SysDictType::getId, dictType.getDictId()));
        return !exist;
    }
    ...
    public String getDictLabel(String dictType, String dictValue, String separator) {
        List<SysDictDataVo> datas = SpringUtil.getBean(this.getClass()).selectDictDataByType(dictType);
