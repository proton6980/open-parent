...
public class SysDeptController extends BaseController {
    ...
    public R<Void> edit(@Validated @RequestBody SysDeptBo dept) {
        ...
        } else if (StringUtils.equals(Constants.DISABLE, dept.getStatus())) {
    ...
    public R<List<SysDeptVo>> optionselect(@RequestParam(required = false) Long[] deptIds) {
        return R.ok(deptService.selectDeptByIds(deptIds == null ? null : Arrays.asList(deptIds)));
    }
