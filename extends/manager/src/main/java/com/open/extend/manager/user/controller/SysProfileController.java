...
import com.open.commons.utils.file.MimeTypeUtils;
import com.open.extend.manager.user.domain.bo.SysUserBo;
import com.open.extend.manager.user.domain.bo.SysUserPasswordBo;
import com.open.extend.manager.user.domain.bo.SysUserProfileBo;
import com.open.extend.manager.user.domain.vo.AvatarVo;
import com.open.extend.manager.user.domain.vo.ProfileVo;
