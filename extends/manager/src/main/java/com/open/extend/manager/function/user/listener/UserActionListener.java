package com.open.extend.manager.function.user.listener;
...
import com.open.extend.manager.function.user.domain.SysUserOnline;
import com.open.extend.manager.function.user.constants.UserConstants;
...
public class UserActionListener implements SaTokenListener {
    ...
    public void doLogin(String loginType, Object loginId, String tokenValue, SaLoginParameter loginParameter) {
        ...
        TenantHelper.dynamic(tenantId, () -> {
            if (loginParameter.getTimeout() == -1) {
                RedisUtils.setCacheObject(UserConstants.ONLINE_TOKEN_KEY + tokenValue, userOnline);
            } else {
                RedisUtils.setCacheObject(UserConstants.ONLINE_TOKEN_KEY + tokenValue, userOnline, Duration.ofSeconds(loginParameter.getTimeout()));
            }
        });
        // 记录登录日志
    ...
    public void doLogout(String loginType, Object loginId, String tokenValue) {
        ...
        TenantHelper.dynamic(tenantId, () -> {
            RedisUtils.deleteObject(UserConstants.ONLINE_TOKEN_KEY + tokenValue);
        });
