...
import com.open.extend.manager.domain.SysUserPost;
import com.open.extend.manager.domain.bo.SysPostBo;
import com.open.extend.manager.domain.vo.SysPostVo;
import com.open.extend.manager.mapper.SysDeptMapper;
import com.open.extend.manager.mapper.SysPostMapper;
import com.open.extend.manager.mapper.SysUserPostMapper;
import com.open.extend.manager.service.ISysPostService;
...
public class SysPostServiceImpl implements ISysPostService {
    ...
    public List<SysPostVo> selectPostByIds(List<Long> postIds) {
        return baseMapper.selectVoList(new LambdaQueryWrapper<SysPost>()
            ...
            .eq(SysPost::getStatus, Constants.NORMAL)
