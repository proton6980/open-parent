package com.open.extend.manager.function.dept.mapper;
 ...
 */
@Mapper
@ConditionalOnMissingBean(ISysDeptMapper.class)
public interface ISysDeptMapper extends IBaseMapper<SysDept, SysDeptVo> {
