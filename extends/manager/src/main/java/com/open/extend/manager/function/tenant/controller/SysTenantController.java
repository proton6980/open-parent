package com.open.extend.manager.function.tenant.controller;
...
public class SysTenantController extends BaseController {
    ...
    @RepeatSubmit()
    @PostMapping()
    public R<Void> add(@Validated(Save.class) @RequestBody SysTenantBo bo) {
    ...
    @RepeatSubmit()
    @PutMapping()
    public R<Void> edit(@Validated(Update.class) @RequestBody SysTenantBo bo) {
