package com.open.extend.manager.function.menu.controller;
...
import com.open.extend.manager.function.menu.domain.vo.MenuTreeSelectVo;
...
public class SysMenuController extends BaseController {
    ...
    public R<Void> add(@Validated @RequestBody SysMenuBo menu) {
        ...
        } else if (Boolean.TRUE.equals(menu.getIsFrame()) && !StringUtils.ishttp(menu.getPath())) {
