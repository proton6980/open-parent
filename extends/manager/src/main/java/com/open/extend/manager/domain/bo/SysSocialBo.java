...
public class SysSocialBo extends TenantAdminEntity {
     ...
     * 认证唯一ID
     */
    @NotBlank(message = "认证唯一ID不能为空", groups = {Save.class, Update.class})
    private String authId;

    /**
     * 用户来源
     */
    @NotBlank(message = "用户来源不能为空", groups = {Save.class, Update.class})
    private String source;

    /**
     * 用户的授权令牌
     */
    @NotBlank(message = "用户的授权令牌不能为空", groups = {Save.class, Update.class})
     ...
     * 用户的 ID
     */
    @NotBlank(message = "用户的ID不能为空", groups = {Save.class, Update.class})
    private Long userId;
