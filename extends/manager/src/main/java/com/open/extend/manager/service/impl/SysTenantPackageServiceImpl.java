...
import com.open.extend.manager.domain.SysTenant;
...
import com.open.extend.manager.domain.bo.SysTenantPackageBo;
import com.open.extend.manager.domain.vo.SysTenantPackageVo;
import com.open.extend.manager.mapper.SysTenantMapper;
import com.open.extend.manager.mapper.SysTenantPackageMapper;
import com.open.extend.manager.service.ISysTenantPackageService;
...
public class SysTenantPackageServiceImpl implements ISysTenantPackageService {
    ...
    public List<SysTenantPackageVo> selectList() {
        return baseMapper.selectVoList(new LambdaQueryWrapper<SysTenantPackage>()
                .eq(SysTenantPackage::getStatus, Constants.NORMAL));
    }
