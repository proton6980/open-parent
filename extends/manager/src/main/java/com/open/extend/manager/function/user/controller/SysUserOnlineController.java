...
public class SysUserOnlineController extends BaseController {
    ...
    public TableDataInfo<SysUserOnline> list(String ipaddr, String userName) {
        // 获取所有未过期的 token
        Collection<String> keys = RedisUtils.keys(UserConstants.ONLINE_TOKEN_KEY + "*");
        ...
        for (String key : keys) {
            ...
            userOnlineDTOList.add(RedisUtils.getCacheObject(UserConstants.ONLINE_TOKEN_KEY + token));
        }
    ...
    public TableDataInfo<SysUserOnline> getInfo() {
        ...
        List<SysUserOnline> userOnlineDTOList = tokenIds.stream()
            ...
            .map(token -> (SysUserOnline) RedisUtils.getCacheObject(UserConstants.ONLINE_TOKEN_KEY + token))
