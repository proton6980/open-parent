package com.open.extend.gateway.filter;
        ...
        return new SaReactorFilter()
            ...
            .setAuth(obj -> {
                ...
                if (e instanceof NotLoginException) {
                    return SaResult.error(e.getMessage()).setCode(HttpStatus.HTTP_UNAUTHORIZED);
                }
                return SaResult.error("认证失败，无法访问系统资源").setCode(HttpStatus.HTTP_UNAUTHORIZED);
            });
    }
