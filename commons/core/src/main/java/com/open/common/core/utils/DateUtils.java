...
import com.open.common.core.enums.FormatsType;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static long difference(Date start, Date end, TimeUnit unit) {
        ...
        switch (unit) {
            ...
            case HOURS:
                return diffInMillis / TimeUnit.HOURS.toMillis(1);
            case MINUTES:
                return diffInMillis / TimeUnit.MINUTES.toMillis(1);
            case SECONDS:
                return diffInMillis / TimeUnit.SECONDS.toMillis(1);
            case MILLISECONDS:
                return diffInMillis;
            case MICROSECONDS:
    ...
    public static void validateDateRange(Date startDate, Date endDate, int maxValue, TimeUnit unit) {
        ...
        // 校验时间跨度不超过最大限制
        if (diff > maxValue) {
            throw new RuntimeException("最大时间跨度为 " + maxValue + " " + unit.toString().toLowerCase());
        }
    }
