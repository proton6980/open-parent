...
import com.open.starter.oss.core.OssClient;
...
public class OssFactory {
    ...
    public static OssClient instance() {
        ...
        if (StringUtils.isEmpty(configKey)) {
            throw new RuntimeException("文件存储服务类型无法找到!");
        }
    ...
    public static synchronized OssClient instance(String configKey) {
        ...
        OssProperties properties = JacksonUtils.parseObject(json, OssProperties.class);
