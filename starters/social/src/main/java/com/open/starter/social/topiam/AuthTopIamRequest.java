package com.open.starter.social.topiam;
...
import static com.open.starter.social.topiam.AuthTopIamSource.TOPIAM;
...
public class AuthTopIamRequest extends AuthDefaultRequest {
    ...
    public static final String SERVER_URL = SpringUtil.getProperty("justauth.type.topiam.server-url");
    ...
    public AuthToken getAccessToken(AuthCallback authCallback) {
        ...
        Dict object = JacksonUtils.parseMap(body);
    ...
    protected String doPostAuthorizationCode(String code) {
        HttpRequest request = HttpRequest.post(source.accessToken())
            .header("Authorization", "Basic " + Base64.encode(String.format("%s:%s", config.getClientId(), config.getClientSecret())))
