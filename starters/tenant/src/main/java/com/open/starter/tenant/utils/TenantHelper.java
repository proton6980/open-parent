package com.open.starter.tenant.utils;
...
public class TenantHelper {
    ...
    public static boolean isEnable() {
        return Convert.toBool(SpringUtil.getProperty("open.tenant.enable"), false);
    }

    private static IgnoreStrategy getIgnoreStrategy() {
        Object ignoreStrategyLocal = ReflectUtils.getStaticFieldValue(ReflectUtils.getField(InterceptorIgnoreHelper.class, "IGNORE_STRATEGY_LOCAL"));
        if (ignoreStrategyLocal instanceof ThreadLocal<?>) {
            if (((ThreadLocal<?>) ignoreStrategyLocal).get() instanceof IgnoreStrategy)
                return (IgnoreStrategy) ((ThreadLocal<?>) ignoreStrategyLocal).get();
        }
        return null;
    }
