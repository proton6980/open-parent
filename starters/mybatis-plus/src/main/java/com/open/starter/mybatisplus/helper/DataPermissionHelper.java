package com.open.starter.mybatisplus.helper;
...
public class DataPermissionHelper {
    ...
    private static IgnoreStrategy getIgnoreStrategy() {
        ...
        if (ignoreStrategyLocal instanceof ThreadLocal<?>) {
            ThreadLocal<?> IGNORE_STRATEGY_LOCAL = (ThreadLocal<?>) ignoreStrategyLocal;
            if (IGNORE_STRATEGY_LOCAL.get() instanceof IgnoreStrategy) {
                return (IgnoreStrategy) IGNORE_STRATEGY_LOCAL.get();
            }
        }
        return null;
    }
