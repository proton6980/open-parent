package com.open.starter.mybatisplus.interceptor;
...
import com.open.starter.mybatisplus.handler.OpenDataPermissionHandler;
 ...
 */
@Slf4j
public class OpenDataPermissionInterceptor extends BaseMultiTableInnerInterceptor implements InnerInterceptor {

    private final OpenDataPermissionHandler dataPermissionHandler;
     ...
     */
    public OpenDataPermissionInterceptor(String mapperPackage) {
        this.dataPermissionHandler = new OpenDataPermissionHandler(mapperPackage);
    }
